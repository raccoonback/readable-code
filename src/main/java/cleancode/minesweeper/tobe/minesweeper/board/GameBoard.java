...
import static cleancode.minesweeper.tobe.minesweeper.board.position.RelativePosition.SURROUND_POSITIONS;
...
//        openSurroundedCells(cellPosition);
  ...
  private int countNearbyLandMines(CellPosition cellPosition) {
    ...
    return (int) calculateSurroundedPositions(cellPosition, rowSize, colSize)
      .stream()
  ...
  private void openSurroundedCells(CellPosition cellPosition) {
    ...
    if (doesCellHavaLandMineCount(cellPosition)) {
      return;
    }
  ...
  private void openAndPushCellAt(Deque<CellPosition> deque) {
    ...
    if (doesCellHavaLandMineCount(currentCellPosition)) {
      return;
    }
  ...
  private boolean doesCellHavaLandMineCount(CellPosition cellPosition) {
    Cell cell = findCell(cellPosition);
